...
def login():
    if request.method == "POST":
        ...
        # Das Passwort wird nie in Flask-Session oder Datenbank gespeichert.
...
MAX_PLAUSIBLE_GAME_SCORE = 1_000_000_000  # Grober Sanity-Check, kein Anti-Cheat
...
def submit_game_score():
    ...
    if score < 0 or score > MAX_PLAUSIBLE_GAME_SCORE or score != score:  # score != score -> NaN
        return jsonify({"error": "invalid score"}), 400
